...
export const metadata: Metadata = {
  title: "AVantage — Autonomous Fleet Intelligence",
  description:
    "Simulate 100 autonomous vehicles across New York City. Optimize dispatch and repositioning, and discover how operational decisions change fleet economics.",
};
        ...
        <footer className="border-t border-[var(--border)]">
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-5 py-8 text-[12px] text-[var(--fg-faint)]">
            <div className="max-w-2xl leading-relaxed">
              Research simulation. Historical demand patterns and hypothetical
              vehicles. Illustrative economics. Not affiliated with any autonomous
              vehicle operator.
            </div>
